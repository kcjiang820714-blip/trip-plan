...
export const JMA_OFFICE_FORECAST_AREAS = {
  "011000": ["011000"], "012000": ["012010", "012020"], "013000": ["013010", "013020", "013030"], "014100": ["014010", "014020", "014030"], "015000": ["015010", "015020"], "016000": ["016010", "016020", "016030"], "017000": ["017010", "017020"],
  ...
  "360000": ["360010", "360020"], "370000": ["370000"], "380000": ["380010", "380020", "380030"], "390000": ["390010", "390020", "390030"], "400000": ["400010", "400020", "400030", "400040"], "410000": ["410010", "410020"], "420000": ["420010", "420020", "420030", "420040"], "430000": ["430010", "430020", "430030", "430040"], "440000": ["440010", "440020", "440030", "440040"], "450000": ["450010", "450020", "450030", "450040"], "460100": ["460010", "460020", "460030", "460040"], "471000": ["471010", "471020", "471030"], "472000": ["472000"], "473000": ["473000"], "474000": ["474010", "474020"],
};
...
// Every official class10 code can be persisted as jmaAreaCode. Empty temperatureAreaCode means
// the caller must not invent a city station; parseJmaForecast returns null temperature values.
...
export function resolveJmaForecastArea(location) {
  ...
  if (savedCode) {
    const saved = JMA_CLASS10_FORECAST_AREAS.filter((area) => area.areaCode === savedCode);
...
export function parseJmaForecast(payload, { forecastAreaCode, areaCode = forecastAreaCode, temperatureAreaCode = "", targetTimezone = "Asia/Tokyo", targetDate = "" } = {}) {
  try {
    ...
    const temperatureSeries = temperatureAreaCode ? findTemperatureSeries(timeSeries, temperatureAreaCode) : null;
    if (!weatherSeries || !popSeries || (temperatureAreaCode && !temperatureSeries)) return null;
    ...
    const temperatureDates = temperatureSeries ? checkedDates(temperatureSeries.timeDefines, targetTimezone) : [];
    if (!weatherDates || !popDates || (temperatureSeries && !temperatureDates) || !sameLength(weatherSeries.area.weatherCodes, weatherDates) || !sameLength(popSeries.area.pops, popDates)) return null;

    const temperatures = temperatureSeries ? temperatureValues(temperatureSeries.area, temperatureDates) : [];
    if (temperatureSeries && !temperatures) return null;
